...
\begin{equation}
    u'^{new}(x,y) = \frac
    {4(\lambda I_{y'}^2 \bar{u}'^{old} - \lambda I_{x'} I_t - \lambda I_{x'} I_{'}y \bar{v}'^{old})}
    {4(\lambda I_{x'}^2 + \lambda I_{y'}^2 + 4)}
\end{equation}

\begin{equation}
    u'^{new}(x,y) = \frac
    {(\lambda I_{y'}^2 \bar{u}'^{old} - \lambda I_{x'} I_t - \lambda I_{x'} I_{y'} \bar{v}'^{old})}
...
\begin{equation}
    u'^{new}(x,y) = 4\bar{u}'^{old}-\frac{I_{x'}I_t}{I_{x'}^2 + \frac{4}{\lambda}} = \bar{u}'^{old} - \frac{I_{x'}^2 \bar{u}'^{old} + I_{x'}I_t}{I_x^2+\frac{4}{\lambda}}
\end{equation}
